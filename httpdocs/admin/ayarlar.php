														...
														<div class="card-body">
															<div class="form-validation"> 
																<div class="row">
																	...
																	<div class="col-lg-6 mb-3">
																		<div class="form-group row">
																			<label class="col-lg-4 col-form-label" for="val-suggestions"> Sabit Telefon <span class="text-danger">*</span> </label>
																			<div class="col-lg-8">
													...
													<div class="card">
														<div class="card-body">
															<div class="row">
																<div class="col-xl-12 col-lg-12 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Dosya Sayısı <span class="text-danger">*</span> </label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">
																				 
																				<input type="text" name="dosyasayisi" class="form-control" placeholder="Dosya Sayısı" value="<?php echo $row_info["dosyasayisi"]?>">
																			</div>
																		</div>
																	</div> 
																</div>
																...
																<div class="col-xl-12 col-lg-12 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Mühendis   <span class="text-danger">*</span> </label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">
																				 
																				<input type="text" name="muhendis" class="form-control" placeholder="Mühendis"  value="<?php echo $row_info["muhendis"]?>">
																			</div>
																		</div>
																	</div> 
																</div>
